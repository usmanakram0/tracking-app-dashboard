...
export function MobileHeader({ username }: { username: string }) {
  return (
    <header className="portal-mobile-header sticky top-0 z-40 flex items-center justify-between border-b border-slate-800/80 bg-slate-950/90 px-4 py-3 backdrop-blur-xl lg:hidden">
